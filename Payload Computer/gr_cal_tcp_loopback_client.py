...
class gr_cal_tcp_loopback_client(gr.top_block):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self.zeromq_sub_source_0 = zeromq.sub_source(gr.sizeof_gr_complex, 1, 'tcp://127.0.0.1:8810', 10000, False, -1)
        self.zeromq_sub_source_0.set_min_output_buffer(8396800)
        self.uhd_usrp_sink_0 = uhd.usrp_sink(
            ",".join(('recv_frame_size=8200, num_recv_frames=2048', "")),
            uhd.stream_args(
                cpu_format="fc32",
                args='',
        ...
        self.uhd_usrp_sink_0.set_min_output_buffer(8396800)
