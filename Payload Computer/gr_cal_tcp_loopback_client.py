...
class gr_cal_tcp_loopback_client(gr.top_block):
    ...
    def __init__(self, device_transport='send_frame_size=8200, num_send_frames=512'):
        ...
        self.min_buffer = min_buffer = 17*4096*100
        ...
        (self.blocks_vector_to_stream_0).set_min_output_buffer(6963200)
        ...
        (self.blks2_tcp_source_0).set_min_output_buffer(6963200)
