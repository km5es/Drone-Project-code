...
if ls /dev/ttySAC0 | grep -q 'ttySAC0'; then
    ...
    roslaunch mavros apm.launch fcu_url:="/dev/ttySAC0:115200" &
    ...
    roslaunch mavros apm.launch fcu_url:="/dev/ttyFC:115200" &
    ### uncomment for SITL simulations
    #roslaunch mavros apm.launch fcu_url:="udp://:16550@10.42.0.1:16551" &
    ...
    roslaunch mavros apm.launch fcu_url:="/dev/ttyS0:115200" &
    ### uncomment for SITL simulations
    #roslaunch mavros apm.launch fcu_url:="udp://:16550@10.42.0.1:16551" &
