...
class tcp_toggle(gr.top_block):
    ...
    def __init__(self):
        ...
        self.blocks_tcp_server_sink_0 = blocks.tcp_server_sink(gr.sizeof_gr_complex*1, '127.0.0.1', 8800, True)
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_interleave_0, 0), (self.blocks_tcp_server_sink_0, 0))
